		...
		<div class="container">
			...
			<div class="logo-nav">
						...
						<div class="col-md-8 single-right">
							<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
								<div class="flexslider">
									<ul class="slides">
										<li data-thumb="images/img/ipcamera.jpg">
											<div class="thumb-image"> <img src="images/img/ipcamera.jpg" data-imagezoom="true" class="img-responsive"> </div>
										</li>
									</ul>
								</div>
								<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>Wireless Smart Home Security Kit <?php $product_title =  "Wireless Smart Home Security Kit"; ?></h3>
					<div class="rating1">
					...
					<div class="description">
						...
						<p>
							<ul>
								<li>Wireless Smart Home Security Kit available to sell...
								Make your home or office more safer place...  </li>
								<li>IP camera + Door</li>
								<li>Smoke/Gas</li>
								<li>PIR Sensor</li>
							</ul>
						</p>
