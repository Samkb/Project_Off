		...
		<div class="container">
			...
			<div class="logo-nav">
						...
						<div class="col-md-8 single-right">
							<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
								<div class="flexslider">
									<ul class="slides">
										<li data-thumb="images/accessories/videorecorder.jpg">
											<div class="thumb-image"> <img src="images/accessories/videorecorder.jpg" data-imagezoom="true" class="img-responsive"> </div>
										</li>
									</ul>
								</div>
								<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>Video Recorder box <?php $product_title =  "Video Recorder box"; ?></h3>
					<div class="rating1">
