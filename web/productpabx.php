		...
		<div class="container">
			...
			<div class="logo-nav">
						...
						<div class="col-md-8 single-right">
							<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
								<div class="flexslider">
									<ul class="slides">
										<li data-thumb="images/accessories/pabx.jpg">
											<div class="thumb-image"> <img src="images/accessories/pabx.jpg" data-imagezoom="true" class="img-responsive"> </div>
										</li>
									</ul>
								</div>
								<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>Program Control Telephone Exchanger <?php $product_title =  "Program Control Telephone Exchanger"; ?></h3>
					<div class="rating1">
					...
					<div class="description">
						...
						<p><ul>
							<li> 1 GSM + 1 PSTN + 8 Analog Extensions</li>
							<li>Operator Caller ID </li>
							<li>Call Transfer</li>
							<li>Call Forwarding</li>
							<li>Outgoing Call Transfer</li>
							<li>CO to CO Transfer</li>
							<li>Call Pickup</li>
							<li>Three Way Conference etc</li>
