		...
		<div class="container">
			...
			<div class="logo-nav">
						...
						<div class="col-md-8 single-right">
							<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
								<div class="flexslider">
									<ul class="slides">
										<li data-thumb="images/img/cctv7.jpg">
											<div class="thumb-image"> <img src="images/img/cctv7.jpg" data-imagezoom="true" class="img-responsive"> </div>
										</li>
									</ul>
								</div>
								<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>360° panoramic VR Camera <?php $product_title =  "360° panoramic VR Camera"; ?></h3>
					<div class="rating1">
					...
					<div class="description">
						...
						<p><ul>
							<li> Electronic PTZ</li>
							<li>Supper small hard disk space occupation</li>
							<li>360° panoramic</li>
							<li>Support multiple users for remote visiting</li>
							<li>Support smart mobile phone view (android, iphone,etc ,)</li>
							<li>Support Day/Night Vision</li>
						</ul></p>
					</div>
