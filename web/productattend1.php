		...
		<div class="container">
			...
			<div class="logo-nav">
						...
						<div class="col-md-8 single-right">
							<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
								<div class="flexslider">
									<ul class="slides">
										<li data-thumb="images/img/timeattendance1.jpg">
											<div class="thumb-image"> <img src="images/img/timeattendance1.jpg" data-imagezoom="true" class="img-responsive"> </div>
										</li>
									</ul>
								</div>
								<!-- flixslider -->
				...
				<div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
					<h3>Biometric Finger Print Attendance Machine <?php $product_title =  "Biometric Finger Print Attendance Machine"; ?></h3>
					<div class="rating1">
					...
					<div class="description">
						...
						<p>
							<ul>
								<li>Reliable light indicator  </li>
								<li>Marks attendance correctly</li>
								<li>Completely accurate identification</li>
								<li>Faster fingerprint recognition speed</li>
								<li>Larger memory</li>
